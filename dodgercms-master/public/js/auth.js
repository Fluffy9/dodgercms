...
var getCredentials = function(allOrNothing) {
    var credentials = {
        ...
        region: localStorage.getItem('dodgercms-bucket-region')
    };
...
function login(params, callback) {
                        ...
                        async.parallel([
                            ...
                            function(err, results) {
                                if (err) {
                                    ...
                                    localStorage.setItem('dodgercms-remember', params.remember);
                                    ...
                                    localStorage.setItem('dodgercms-bucket-region', params.region);
  ...
  */
  function logout() {
    ...
    localStorage.removeItem('dodgercms-bucket-region');
