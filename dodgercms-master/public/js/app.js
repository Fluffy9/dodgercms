...
$(function() {
  ...
  var BUCKET_REGION = localStorage.getItem('dodgercms-bucket-region');
  ...
  */
  function s3init(force) {
	...
	var region = localStorage.getItem('dodgercms-bucket-region')
      ...
      if (err) {
        ...
        dodgercms.s3.headObjects(data.Contents, DATA_BUCKET, function(err, data) {
          ...
          for (var i = 0; i < data.length; i+=1) {
            ...
            //# Removing this helped list all the contents of the directory. Previously only the bucket name was listed
